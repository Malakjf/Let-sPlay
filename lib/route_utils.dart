...
/*
/// Centralized navigation helper to open the Profile screen.
/// This ensures that all necessary providers are correctly passed to the new route,
/// preventing ProviderNotFoundExceptions.
void openProfileScreen(
  ...
  Navigator.push(
    context,
    MaterialPageRoute(
      builder: (builderContext) => ProfileScreen(
        ctrl: ctrl,
        player: player,
        userPermission: userPermission ?? UserPermission.player,
      ),
    ),
  );
}
